...
public sealed class Achievements
{
    ...
    public static readonly Def[] All =
    {
        ...
        new("mem1",         "Збирач сміття",        "Очистити пам'ять кліком по RAM (GC)",              "🧲"),
        new("order1",       "Режисер вкладок",      "Переставити вкладку драгом",                      "🎬"),
        new("exp1",         "Обмінник",             "Експортувати закладки (HTML)",                     "📤"),
    };
