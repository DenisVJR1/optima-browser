...
### 🏆 Досягнення
- **30 значків-досягнень** (меню ⋮ → Досягнення або лічильник 🏆 на старті): перший запуск, 10/25 вкладок, 50/250/1000 блоків, Konami, Слава Україні, закладки, інкогніто, читання, скріншот, PDF, переклад, Vault, 42, налаштування, Про, зум, середня кнопка, підказки, пошук на сторінці, повний екран, калькулятор, **перше завантаження, TLS-апгрейд, очищення даних, 5 перекладів**.
